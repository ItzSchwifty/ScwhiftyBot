...
async def on_message(message):
        ...
        if message.content.upper().startswith("/INFO"):
                    ...
                    embed.set_thumbnail(url="https://qph.fs.quoracdn.net/main-qimg-cd1da8f17d8d317e5a084282a2758405")
